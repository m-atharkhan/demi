...
void handle_VMUL(CPU& cpu, [[maybe_unused]] const std::vector<uint8_t>& program, [[maybe_unused]] bool& running) {
    Logging::DebugHandler::instance().report(Logging::DebugCategory::CPU_EXECUTION,
        "Executing VMUL - Vector Multiplication", Logging::DebugLevel::DETAIL);
    ...
    Logging::DebugHandler::instance().report(Logging::DebugCategory::CPU_EXECUTION,
        fmt::format("VMUL raw register values: R0={:08X}, R1={:08X}, R2={:08X}, R3={:08X}, R4={:08X}, R5={:08X}, R6={:08X}, R7={:08X}",
